...
import { CheckCircle2, Copy, Radio } from "lucide-react";
...
export function WebSocketSettings({ instanceName }: WebSocketSettingsProps) {
  ...
  const wsUrl = `${
    apiUrl?.replace(/^http/, "ws") || "ws://localhost:8080"
  }/sse/${instanceName}`;
      ...
      <Card className="border-[var(--rocket-gray-600)] bg-[var(--rocket-gray-800)]/50 backdrop-blur-sm">
        <CardHeader className="border-b border-[var(--rocket-gray-600)]">
          <CardTitle className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-[var(--rocket-gray-100)]">
                WebSocket
              </h2>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Button
                  ...
                  className={
                    copied
                      ? "bg-[var(--rocket-green)]/20 text-[var(--rocket-green)] border border-[var(--rocket-green)]/30"
  ...
  console.log('Evento:', data);
          ...
          >
            ...
            <p className="text-sm text-[var(--rocket-gray-300)] leading-relaxed">
              O WebSocket usa Server-Sent Events (SSE) para enviar eventos em
              tempo real. A conexão é mantida automaticamente e reconecta em
